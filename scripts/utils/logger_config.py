"""Logging configuration for EDGAR graph database scripts"""
...
def setup_logger(
    ...
    Args:
        script_name: Name of the script (e.g., 'setup_schema', 'ingest')
    ...
    log_file = log_path / f"{script_name}_{date_str}.log"
    ...
    logger.info(f"Logger configured: {script_name}")
...
def get_logger(name: Optional[str] = None):
    """
    Get a logger instance. If logger hasn't been configured, returns default logger.
